...
using TestAp.Data;
using TestAp.Forms;
using TestAp.Forms.Droid;
using TestAp.Forms.Droid.BroadcastReceiver;
using Xamarin.Forms;

namespace TestAp.Droid
{
	[Activity(Label = "TestAp.Droid", Icon = "@drawable/icon", Theme = "@style/MyTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
