...
using TestAp.Data;
using TestAp.Forms;
using TestAp.Forms.iOS;
using UIKit;

namespace TestAp.iOS
{
	...
	public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate
	{
		...
		{
			var logger = (TestAp.Common.Logging.ILogger)ContainerManager.Container.Resolve(typeof(TestAp.Common.Logging.ILogger), typeof(TestAp.Common.Logging.ILogger).GetType().ToString());
