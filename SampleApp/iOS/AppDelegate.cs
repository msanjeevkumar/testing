...
namespace SampleApp.iOS
{
	...
	public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate
	{
		...
		{
			var logger = (SampleApp.Common.Logging.ILogger)ContainerManager.Container.Resolve(typeof(SampleApp.Common.Logging.ILogger), typeof(SampleApp.Common.Logging.ILogger).GetType().ToString());
