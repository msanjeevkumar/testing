...
namespace FastBar.iOS
{
	...
	public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate
	{
		...
		{
			var logger = (FastBar.Common.Logging.ILogger)ContainerManager.Container.Resolve(typeof(FastBar.Common.Logging.ILogger), typeof(FastBar.Common.Logging.ILogger).GetType().ToString());
